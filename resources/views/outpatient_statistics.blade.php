       ...
       <!-- Left side column. contains the logo and sidebar -->
        ...
        <section class="sidebar">
         ...
         <ul class="sidebar-menu">
            <li class="treeview">
                <a href="hospital_statistics" class="main"><i class="fa  fa-folder-open-o"></i></span><span >Стационар</span></a></li>
               ...
               <li class="treeview">
                 <a href="look_outpatient_stat" class="main"><i class="fa fa-eye"></i> <span>Просмотр отчета</span></a>
              </li> 
              <li class="treeview">
         ...
         <!-- Main content -->
          ...
          <!-- Main row -->
             <div class="box box-primary">
               <!-- form start -->
                    		   {!! Form::open(array('route' => 'outpatient_add', 'class' => 'form-horizontal', 'files'=>true)) !!} 
                    ...
                    <div class="form-group">
                      <label class="col-sm-2 control-label">Тип дневного стационара</label>
                      <div class="col-sm-10">
        ...
        <!--         <button type="submit" class="btn btn-primary pull-left" style="margin:20px 10px 0px 0px;"> <i class="fa fa-edit" style="color: white;" ></i> Редактировать</button>
              ...
              <tr role="row">
                <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Rendering engine: activate to sort column descending" aria-sort="ascending">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Количество коек (с учетом коэффициента сменности)</th>
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Состояло на начало дня</th>
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="1">Поступило</th> <!--есть скрипт с сортировкой, но он слетел-->
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="2">Выписано</th>
                  </tr>
                </thead>
                <tbody>
                ...
                <th rowspan="1" colspan="1">Количество коек(с учетом коэффициента сменности)</th>
                <th rowspan="1" colspan="1">Состояло на начло дня</th>
                <th rowspan="1" colspan="1">Поступило</th>
                <th rowspan="1" colspan="1">Выписано</th></tr>
                </tfoot>
