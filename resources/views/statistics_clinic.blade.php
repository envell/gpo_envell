    ...
    <div class="wrapper">
      ...
      <!-- Left side column. contains the logo and sidebar -->
        ...
        <!-- sidebar: style can be found in sidebar.less -->
          ...
          <ul class="sidebar-menu">
            <li class="treeview">
              ...
              <li class="treeview">
                 <a href="statistics_clinic" class="main"><i class="fa  fa-folder-o" style="color:white;"></i> <span class = "White">Поликлиника</span></a>
              </li>
               <li class="treeview">
                 <a href="#" class="main"><i class="fa fa-edit" style="color: white;" ></i> <span style="color:white;">Редактирование данных</span></a>
              </li> 
               <li class="treeview">
                 <a href="look_clinic_stat" class="main"><i class="fa fa-eye"></i> <span>Просмотр отчета</span></a>
              </li> 
              <li class="treeview">
       ...
       <input type="text" class="form-control" name="held_beddays">
                      ...
                      <div class="col-sm-10"> <input type="text" class="form-control" name="held_beddays">
                      </div>
                    </div>
                      <div class="box-body">
                    <div class="form-group">
...
<input type="text" class="form-control" name="held_beddays"> <!--Сережин скрипт выдает ошибку, надо исправить и вернуть-->
        ...
        <!--         <button type="submit" class="btn btn-primary pull-left" style="margin:20px 10px 0px 0px;"> <i class="fa fa-edit" style="color: white;" ></i> Редактировать</button>
              ...
              <tr role="row">
                <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="3" colspan="1" aria-label="Rendering engine: activate to sort column descending" aria-sort="ascending">ФИО</th>
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="3" colspan="1" aria-label="Browser: activate to sort column ascending">Должность</th>
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="9" aria-label="Platform(s): activate to sort column ascending">Число посещений</th>
                  </tr>
                    <tr role="row">
                <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="3" aria-label="Rendering engine: activate to sort column descending" aria-sort="ascending">в поликлиниике</th>
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="3" aria-label="Browser: activate to sort column ascending">на дому</th>
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="3" aria-label="Platform(s): activate to sort column ascending">по видам оплаты</th>
                 
                  </tr>
                  <tr role="row">
                <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Rendering engine: activate to sort column descending" aria-sort="ascending">всего</th>
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">по заболеванию</th>
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">профилактические</th>
                 <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Rendering engine: activate to sort column descending" aria-sort="ascending">всего</th>
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">по заболеванию</th>
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">профилактические</th>
                 <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Rendering engine: activate to sort column descending" aria-sort="ascending">всего</th>
